# Generated by Django 5.1.5 on 2025-02-04 02:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant_code', models.CharField(max_length=10)),
                ...
                ('ime_transaction_status', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(4)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('navyabasemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='payment.navyabasemodel')),
                ('payment_partner', models.TextField(choices=[('eSewa', 'ESEWA'), ('IME Pay', 'IME_PAY'), ('Khalti', 'KHALTI'), ('Connect IPS', 'CONNECT_IPS')])),
