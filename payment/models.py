...
class PaymentRequest(NavyaBaseModel):
    ...
    #     FAILED = 'FAILED'
    #     CANCELLED = 'CANCELLED'
    payment_partner = models.TextField(choices=PaymentVendor.choices(), null=False, blank=False)
    ...
    amount = models.DecimalField(decimal_places=2, max_digits=25, null=False, blank=False)
    # partners like khalti and connectIPS take amount in paisa, might be useful to store amount in paisa for future reference
    amount_in_paisa = models.DecimalField(decimal_places=2, max_digits=30, null=True, blank=True)
...
class ImePayDetails(NavyaBaseModel):
    ...
    merchant_code = models.CharField(max_length=10, null=False, blank=False)
    transaction_amount = models.DecimalField(decimal_places=2, max_digits=10, null=False, blank=False)
    ...
    token_id = models.CharField(max_length=20, null=False, blank=False)
    ...
    request_date = models.DateTimeField(null=False, blank=False)
    response_date = models.DateTimeField(null=False, blank=False)
